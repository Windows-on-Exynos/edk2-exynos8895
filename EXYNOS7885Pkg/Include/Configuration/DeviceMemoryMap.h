...
//--------------------- DDR --------------------- */
    ...
    {"HLOS 1.5",          0x90000000, 0x30080000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    {"UEFI FD",           0xC0080000, 0x00200000, AddMem, SYS_MEM, SYS_MEM_CAP, BsCode, WRITE_BACK},
    {"HLOS 2",            0xC0280000, 0x0BE00000, AddMem, SYS_MEM, SYS_MEM_CAP, Conv,   WRITE_BACK},
    /*Memory hole 0xbbc00000 -> 0xc0000000*/
    {"Display Reserved",  0xCC000000, 0x00800000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
    {"HLOS 3",            0xCC800000, 0x2C000000, AddMem, SYS_MEM, SYS_MEM_CAP,  Conv,   WRITE_BACK},
